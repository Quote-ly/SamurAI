...
SYSTEM_PROMPT = (
    ...
    "- Use fill_spreadsheet_column to fill columns using a Python expression per row.\n"
    "- Use edit_spreadsheet for specific cell updates.\n"
    "- Use edit_document for .docx file modifications.\n"
    "- ALWAYS call the edit/fill tool and return the modified file. Do NOT just describe what you would do.\n"
